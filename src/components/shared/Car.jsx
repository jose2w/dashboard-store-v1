...
const Car = (props) => {
  ...
  return (
    <div className={`lg:col-span-2 fixed   top-0 bg-[#1F1D2B] w-full h-full lg:right-0 lg:w-96
        transition-all z-50
         ${showOrder ? "right-0" : "-right-full"}`}>
         {/* Orders */}
         <div className="relative pt-16 lg:pt8 text-gray-300 p-8 h-full">
           ...
           <h1 className="text-2xl my-4">Orders #151635</h1>
